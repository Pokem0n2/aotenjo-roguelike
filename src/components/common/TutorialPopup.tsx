    ...
    <div className="codex-overlay" onClick={onClose}>
      <div className="tutorial-menu" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="tutorial-section">
          ...
          <p>每局通过 <strong>4 次出牌</strong>累积得分，达到目标分数即可通关。共 16 局（东南西北 × 4 局）。</p>
        </div>

        <div className="tutorial-section">
          <h4 className="tutorial-heading">如何出牌</h4>
          <p>从手牌中选出 <strong>5 张牌</strong>（一组面子 + 一对），或 <strong>6 张牌</strong>（一杠 + 一对）。</p>
          <ul>
            <li><strong>面子</strong>（3张）：顺子（同花色连续3张，如一二三万）或刻子（3张相同的牌）</li>
        ...
        <div className="tutorial-section">
          ...
          <ul>
            <li><strong>符</strong>：每张牌有基础符值，遗物可加符</li>
